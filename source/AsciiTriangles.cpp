...
int main()
{
    ...
    RenderManager renderer(&device, Camera(glm::vec3(0.0f, 0.0f, 0.0f), 30.0f, 0.01f, 1000.0f), false, 20, 8);

    MaterialProperties shader = MaterialProperties();
    MeshGeometry* TriForce = new MeshGeometry(shader);
