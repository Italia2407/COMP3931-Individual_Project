...
int main()
{
    ...
    MeshProperties sphereMaterial(glm::vec3(1.0f, 1.0f, 1.0f));
    ...
    renderer.AddLight(glm::vec3(0.0f, -1.5f, -1.3f), glm::vec3(1.0f, 0.5f, 0.0f), 24.0f);
    renderer.AddLight(glm::vec3(2.0f, 0.0f, -1.5f), glm::vec3(0.85f, 0.0f, 1.0f), 18.0f);
